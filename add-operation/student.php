...
<?php
    ...
    if(isset($_POST['add'])){
        ...
        $sql2 = "INSERT INTO current VALUES ('$sapid','$fees','$div')";
    ...
    <div id="right-panel" class="right-panel">
        <header id="header" class="header">
            ...
            <div class="header-menu">
                ...
                <h1 class="top-header">Governemnt College of Engineering, Yavatmal</h1>
            </div>
        </header>
            ...
            <div class=" col-md-6">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="text-input" class=" form-control-label">PRN</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="number" id="text-input" name="sap" placeholder="PRN Number" class="form-control">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="div" placeholder="Division" class="form-control">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="email" id="email-input" name="email-input" placeholder="Email ID" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="number" id="text-input" name="fees" placeholder="100000" class="form-control">
