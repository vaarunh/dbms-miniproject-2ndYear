...
<body>
    ...
    if(isset($_POST['add'])){
        ...
        VALUES ('$sapid','$name','$gender','$dob','$mobile','$address','$dept','$age')";
...
?>
                <div class="card">
                    ...
                    <div class="card-body card-block">
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="text-input" class=" form-control-label">EMP ID</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="number" id="text-input" name="sap" placeholder="EMP ID" class="form-control">
